...
from strands_costguard.metrics.otel import MetricsEmitter
from strands_costguard.policies.budget import BudgetSpec, HardLimitAction, ThresholdAction
from strands_costguard.policies.store import PolicyStore
from strands_costguard.pricing.table import PricingTable
...
class CostGuard:
    ...
    def __post_init__(self) -> None:
        ...
        self._budget_tracker = BudgetTracker(store=self.config.budget_store)
